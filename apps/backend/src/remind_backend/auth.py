...
from remind_backend.database import UserModel, RateLimitModel, UsageLogModel
from remind_backend.models import PlanTier, PLAN_CONFIGS
...
def check_rate_limit(db: Session, user_id: int) -> int:
    """Check rate limit for user. Returns remaining requests."""
